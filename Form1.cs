    ...
    public partial class Form1 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (Wrapper.simxGetConnectionId(clientID) != -1)
            {
                ...
                if (Wrapper.simxGetVisionSensorImage(clientID, Visionsensor, out resolution[0], out image1, '0', simx_opmode.buffer) == 0)
                {
                ...
                if (Wrapper.simxGetVisionSensorImage(clientID, VisionsensorC, out resolution[0], out image2, '0', simx_opmode.buffer) == 0)
                {
                ...
                if (Wrapper.simxGetVisionSensorImage(clientID, VisionsensorF, out resolution[0], out image3, '0', simx_opmode.buffer) == 0)
                {
